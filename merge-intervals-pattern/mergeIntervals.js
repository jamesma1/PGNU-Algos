...
function merge(intervals) {
  ...
  for (i = 1; i < intervals.length; i++) {
    const interval = intervals[i]; // interval "b"
...
We will also need O(N) space for sorting. For Java, depending on its version, Collections.sort() either uses Merge sort or Timsort, 
